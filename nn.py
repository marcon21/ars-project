...
class NN(nn.Module):
    ...
    def forward(self, x):
        ...
        self.fc1.bias.data = torch.randn_like(self.fc1.bias.data)  
        self.fc2.bias.data = torch.randn_like(self.fc2.bias.data)
        self.fc3.bias.data = torch.randn_like(self.fc3.bias.data)
