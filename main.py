...
land6 = Landmark(300, 3, 10, "c", "purple")
land7 = Landmark(30, 5, 10, "c", "purple")
land8 = Landmark(10, 200, 10, "c", "purple")
land9 = Landmark(60, 40, 5, "c", "purple")
env.add_landmark(land1)
env.add_landmark(land2)
env.add_landmark(land3)
env.add_landmark(land4)
env.add_landmark(land5)
env.add_landmark(land6)
env.add_landmark(land7)
env.add_landmark(land8)
env.add_landmark(land9)
